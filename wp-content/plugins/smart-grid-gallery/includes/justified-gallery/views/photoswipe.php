    ...
    <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden">
            ...
            <div class="pswp__top-bar">
                ...
                <?php if ($this->lightbox_atts['print'] == 'true'): ?>
                <button class="pswp__button pswp__button--print" title="Print"></button>
                <?php endif; ?>
    ...
    var SGGinitPhotoSwipeFromDOM = function(gallerySelector, shortcodeOptions) {
        ...
        function videoParseUrl(url){
            ...
            if (parsed) {
                ...
                if (match) {
                    return "//www.youtube.com/embed/" + match[2]  + "<?php echo $rel; ?>";
                } else {
                    return 'error';
                }
            }
...
<iframe id="sgg-printing-frame" name="sgg_print_frame" src="about:blank" style="display:none;"></iframe>